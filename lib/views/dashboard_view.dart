            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Center(child: Text('Pegawai Rajin', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),)),
                  SizedBox(height: 5,),
                      ...
                      child: Row(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Column(
                              children: [
                                Text('07:30', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold),),
                                Text('Jam Masuk', style: TextStyle(color: Colors.white, fontSize: 16),),
                              ],
                            ),
                          ),
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: [
                                Text('07:30', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold),),
                                Text('Jam Pulang', style: TextStyle(color: Colors.white, fontSize: 16),),
                              ],
                            ),
                          )
                      ],
      ...
      child: Row(
        children: [
          ClipRRect(
            ...
            child: Image.asset('assets/foto.jpg', width: 75, height: 75,
            fit: BoxFit.cover,),
          ),
